...
*** Compute
   ...
   | double        | elec_coord[walk_num][3][elec_num]                                  | in  | Electron coordinates                  |
   | double        | nucl_coord[3][elec_num]                                            | in  | Nuclear coordinates                   |
   | double        | en_distance_rescaled_deriv_e_date[walk_num][nucl_num][elec_num][4] | out | Electron-nucleus distance derivatives |
...
double en_distance_rescaled_deriv_e[walk_num][nucl_num][elec_num][4];
