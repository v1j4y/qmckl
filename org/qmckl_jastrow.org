    ...
    for i in range(elec_num):
      ...
      for ii in range(4):
        een_rescaled_n_deriv_e[i, ii, a, l] = een_rescaled_n_deriv_e[i, ii, a, l] * \
                                               een_rescaled_n[a, i, l]

print(" een_rescaled_n[0, 2, 1] = ",een_rescaled_n_deriv_e[2, 0, 0, 1])
print(" een_rescaled_n[0, 3, 1] = ",een_rescaled_n_deriv_e[3, 0, 0, 1])
print(" een_rescaled_n[0, 4, 1] = ",een_rescaled_n_deriv_e[4, 0, 0, 1])
print(" een_rescaled_n[1, 3, 2] = ",een_rescaled_n_deriv_e[3, 0, 1, 2])
print(" een_rescaled_n[1, 4, 2] = ",een_rescaled_n_deriv_e[4, 0, 1, 2])
print(" een_rescaled_n[1, 5, 2] = ",een_rescaled_n_deriv_e[5, 0, 1, 2])
    #+end_src

    #+RESULTS:
    :  een_rescaled_n[0, 2, 1] =  -0.07633444246999128
    :  een_rescaled_n[0, 3, 1] =  0.00033282346259738276
    :  een_rescaled_n[0, 4, 1] =  -0.004775370547333061
    :  een_rescaled_n[1, 3, 2] =  0.1362654644223866
    :  een_rescaled_n[1, 4, 2] =  -0.0231253431662794
    :  een_rescaled_n[1, 5, 2] =  0.001593334817691633
